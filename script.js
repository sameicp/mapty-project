...
class App {
  ...
  _loadMap(position) {
    ...
    this.#workouts.forEach(workout => this._setMapMarker(workout));
  }
  ...
  _newWorkout(e) {
    ...
    const isValidInputs = (...numbers) =>
      isNumber(...numbers) && isPositiveNumber(...numbers);
    ...
    if (type === 'running') {
      ...
      if (!isValidInputs(cadence, distance, duration)) {
    ...
    if (type === 'cycling') {
      ...
      if (
        !isNumber(elevation, distance, duration) ||
